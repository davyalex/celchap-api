...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-light ec-header-light text-dark" id="body" >
            ...
            <div id="sidebar" class="sidebar ec-sidebar-footer">
                ...
                <div class="ec-brand">
                    <a href="index.html" title="Ekka">
                        ...
                        <span class="ec-brand-name text-truncate">LIKIDON</span>
                    </a>
                </div>
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)">
                                ...
                                <span class="nav-text">Fournisseurs</span> <b class="caret"></b>
                            </a>
                            <div class="collapse">
                        ...
                        <li class="has-sub">
                            ...
                            <div class="collapse">
                                <ul class="sub-menu" id="categorys" data-parent="#sidebar-menu">
                                    <li class="">
                                        <a class="sidenav-item-link" href="{{ route('admin.categorie.index') }}">
                                            <span class="nav-text"> Categorie principale</span>
                                        </a>
                                    </li>
                                    {{-- <li class="">
                         ...
                         <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)">
                                <i class="mdi mdi-dns-outline"></i>
                                <span class="nav-text">Livraison</span> <b class="caret"></b>
                            </a>
                            <div class="collapse">
                                <ul class="sub-menu" id="categorys" data-parent="#sidebar-menu">
                                    <li class="">
                                        <a class="sidenav-item-link" href="{{ route('admin.livraison.index') }}">
                                            <span class="nav-text">Zone de livraison</span>
                                        </a>
                                    </li>
